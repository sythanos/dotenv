...
I also use special journal templates. For this I need first add some time format functions.
#+begin_src emacs-lisp

#+end_src

And finally define new dailies templates.
#+begin_src emacs-lisp
(after! org-roam
  (setq org-roam-dailies-capture-templates
        '(("m" "Daily-0: Morning Kick-off" plain (file "Templates/daily_0.org")
...
(defun urb/org-roam-goto-today ()
  (interactive)
  (org-roam-dailies-capture-today t "m"))
