...
(after! org
  (setq org-agenda-files (list urb/cortex-dir)))
...
(after! org-roam
  (let ((header (concat "#+TITLE: %<%Y-%m-%d>.org\n"
                        "#+FILETAGS: Daily\n\n"
                        "Next: \n"
                        "Previous: \n\n"
                        "* Journal\n\n"
  ...
  (setq org-roam-dailies-capture-templates
        '(("j" "Journal Entry" plain "%?"
           :target (file+head+olp "%<%Y-%m-%d>.org" header ("Journal"))
           :unnarrowed t)
          ("n" "Day Note" entry "* %<%H:%M>\n%?%i"
           :target (file+head+olp "%<%Y-%m-%d>.org" header ("Day Notes"))))))
...
(defun urb/org-roam-goto-today ()
  (interactive)
  (org-roam-dailies-capture-today t "n"))
